...
const BenefitsOfPartnership = () => {
  return (
    <div className="bg-[#010C09] text-white font-sans">
      ...
      {/* Main Content */}
      <div className="w-full text-center py-12 p-6">
        {/* Header Text */}
        <div className="space-y-6 w-full">
          <p className="text-white text-xl font-medium">
            Partner with Kraf Technology
          </p>
          <h1 className="lg:text-7xl sm:text-5xl font-bold leading-tight py-12">
            Benefits that make <br className="hidden sm:block" /> the difference
          </h1>
          <p className="text-4xl text-white max-w-5xl mx-auto">
        ...
        <div className="space-y-4 max-w-7xl mx-auto px-4 py-12 text-left">
          <h2 className="text-6xl  font-bold text-left  w-[80%] min-w-[200px]">
            The only all-in-one portable benefits platform
          </h2>
          <p className="text-4xl text-gray-300 text-left">

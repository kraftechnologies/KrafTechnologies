  ...
  const testimonials = [
    {
      ...
      years: "2 Month at KT",
      quote:
        "The internship has been amazing! Our mentors provide great support, ensuring we understand our tasks while challenging us to learn and explore new things.",
      avatar: john,
    },
    {
      ...
      quote:
        "I'm completely satisfied with the process and genuinely enjoying it!",
      avatar: aditya,
    },
    {
      name: "Suyesh Kumar",
      ...
      years: "1 years at KT",
      quote:
        "A smooth, well-structured process with great team support. Every challenge is a learning opportunity, and Kraf's commitment to excellence is inspiring.",
      avatar:
        "https://ideogram.ai/assets/progressive-image/balanced/response/Jse3aie5Tq-6aY3fgOFjQQ",
    },
    {
      name: "Tanya Singh",
      ...
      years: "1 year at KT",
      quote:
        "Kraf Technologies fosters innovation and growth. The supportive team and exciting projects make it a great place to learn and excel.",
      avatar:
        "https://ideogram.ai/assets/progressive-image/balanced/response/bIzTNrmdTw-AkOrnPAk-vA",
    },
    {
      name: "Ishika Kapoor",
      ...
      years: "1 years at KT",
      quote:
        "Kraf Technologies provides a dynamic and learning-driven environment. The collaborative culture and challenging projects keep me motivated every day.",
      avatar:
        "https://media.licdn.com/dms/image/v2/D5603AQHSHLwJwMXPgQ/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1723928266461?e=1748476800&v=beta&t=_ZSEqNH297hbrAfc5OU90sTEwXqgFLPFUUifNCb9XGM",
    },
    {
      name: "Diya Arora",
      position: "HR Intern",
      years: "2 Months at KT",
      quote:
        "Kraf Technologies' mentors provided exceptional support, guidance, and insights into HR processes, recruitment, and employee engagement, fostering learning and professional growth.",
      avatar: diya,
    },
    {
      name: "Aditya Mehta",
      ...
      years: "2 years at KT",
      quote:
        "Kraf Technologies fosters growth, collaboration, and innovation, providing a dynamic environment with exciting projects and continuous learning opportunities every day.",
      avatar:
        "https://ideogram.ai/assets/progressive-image/balanced/response/CCfEMUxvQL6zwYqM9XyTfA",
    },
    {
      name: "Apurva",
      ...
      years: "1 years at KT",
      quote:
        "Kraf Technologies offers great professional growth with a supportive team, innovative strategies, and hands-on experience, enhancing my sales and marketing expertise.",
      avatar:
        "https://ideogram.ai/assets/progressive-image/balanced/response/fsdOexcqTV-ONBZRLs5tTA",
    },
  ];
    ...
    <div className="career-container">
        ...
        <div className="container mx-auto px-4 z-10 relative">
          <div className="max-w-2xl">
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight tracking-tight">
              Join Our Work Environment &{" "}
              <span className="text-[#18cb96]">Build the Future</span>
            </h1>
            <p className="text-lg md:text-xl mb-8 text-gray-300 font-light text-justify">
              At Kraf Technologies, we're pushing the boundaries of innovation.
              Join our team of visionaries and help shape tomorrow's technology
              landscape.
            </p>
            ...
            {[
              {
                ...
                description:
                  "Be part of a forward-thinking team that embraces new ideas and technologies.",
              },
              {
      ...
      <section className="py-20 bg-gradient-to-b from-black to-gray-900">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-gray-400 max-w-2xl mx-auto mb-16 font-light">
            Hear directly from our team members about their experiences working
          ...
          <div className="relative overflow-hidden py-10">
            <div className="flex animate-marquee whitespace-nowrap">
              {testimonials.concat(testimonials).map(
                (
                  testimonial,
                  index // Duplicate array for seamless loop
                ) => (
                  <div
      ...
      <section className="py-20 bg-black">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-center mb-4 tracking-tight">
            Your <span className="text-[#18cb96]">Career Journey</span> at Kraf
            Technologies
          </h2>
          <p className="text-center text-gray-400 max-w-2xl mx-auto mb-16 font-light">
            We provide a clear path for growth and development, supporting you
                ...
                items: [
                  {
                    ...
                    description:
                      "A structured 2-week program to get you familiar with our tools, processes, and culture.",
                  },
                  {
                    icon: <Users className="h-5 w-5" />,
                    title: "Mentorship Program",
                    description:
                      "One-on-one guidance from an experienced team member for your first 3 months.",
                  },
                  {
                    icon: <Target className="h-5 w-5" />,
                    title: "Initial Projects",
                    description:
                      "Carefully selected assignments to help you apply your skills while learning our systems.",
                  },
                ],
              },
              {
                ...
                items: [
                  {
                    ...
                    description:
                      "$5,000 annual education budget for courses, conferences, and certifications.",
                  },
                  {
                    icon: <Users className="h-5 w-5" />,
                    title: "Cross-functional Projects",
                    description:
                      "Opportunities to work with different teams to broaden your expertise.",
                  },
                  {
                    icon: <BarChart className="h-5 w-5" />,
                    title: "Regular Feedback Cycles",
                    description:
                      "Quarterly reviews and continuous feedback to support your development.",
                  },
                ],
              },
              {
                ...
                items: [
                  {
                    ...
                    description:
                      "Lead initiatives and drive innovation with support from senior leadership.",
                  },
                  {
                    icon: <Users className="h-5 w-5" />,
                    title: "Mentoring Others",
                    description:
                      "Opportunity to mentor new team members and develop leadership skills.",
                  },
                  {
                    icon: <Zap className="h-5 w-5" />,
                    title: "Innovation Time",
                    description:
                      "10% of your time dedicated to exploring new ideas and technologies.",
                  },
                ],
              },
              {
                ...
                items: [
                  {
                    ...
                    description:
                      "Transparent promotion criteria and career ladders in technical and management tracks.",
                  },
                  {
                    icon: <Award className="h-5 w-5" />,
                    title: "Recognition Programs",
                    description:
                      "Quarterly and annual awards for outstanding contributions and achievements.",
                  },
                  {
                    icon: <Shield className="h-5 w-5" />,
                    title: "Equity & Ownership",
                    description:
                      "Stock options and profit-sharing to align your success with company growth.",
                  },
                ],
              },
            ].map((stage, index) => (
                    ...
                    <div className="space-y-4">
                      {stage.items.map((item, itemIndex) => (
                        <div key={itemIndex} className="flex items-start gap-3">
                          <div className="bg-gray-800 p-2 rounded-lg flex-shrink-0 mt-1 text-[#18cb96]">
                            {item.icon}
                          </div>
                          <div>
                            <h4 className="font-semibold text-[#18cb96]">
                              {item.title}
                            </h4>
                      ...
                      <div className="space-y-4">
                        {[
                          ...
                          >
                            ...
                            <div className="bg-gray-800 p-2 rounded-lg flex-shrink-0 text-[#18cb96]">
                              {item.icon}
                            </div>
                          </div>
                        ))}
